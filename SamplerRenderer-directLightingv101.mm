...
<node COLOR="#338800" CREATED="1501127505346" ID="ID_1043405659" MODIFIED="1501829839379" TEXT="Sample *sample=new Sample(sampler,surfaceIntegrator,volumeIntegrator,scene);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
<node CREATED="1501127733431" ID="ID_1975506111" MODIFIED="1501829839379" TEXT="if(surf) surf-&gt;RequestSamples(sampler,this,scene);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node COLOR="#338800" CREATED="1501814476241" FOLDED="true" ID="ID_629848443" MODIFIED="1501829839374" TEXT="int sampleCount=sampler-&gt;GetMoreSamples(samples,rng);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node COLOR="#006699" CREATED="1501158278298" ID="ID_1991648994" MODIFIED="1501829877636" POSITION="right" TEXT="Spectrum SamplerRenderer::Li(const Scene *scene,const RayDifferential &amp;ray,const Sample *sample,RNG &amp;rng,MemoryArena &amp;arena,Intersection *isect,Spectrum *T)">
...
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
<node CREATED="1501154229887" ID="ID_770764746" MODIFIED="1501829880582" TEXT="Li=surfaceIntegrator-&gt;Li(scene,this,ray,*isect,sample,rng,arena);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node COLOR="#338800" CREATED="1501154471808" FOLDED="true" ID="ID_212894413" MODIFIED="1501829839364" TEXT="BSDF *bsdf = isect.GetBSDF(ray, arena);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node CREATED="1501817680500" ID="ID_1702740476" MODIFIED="1501829839362" TEXT="if(scene-&gt;lights.size()&gt;0)">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
<node COLOR="#999999" CREATED="1501817696403" ID="ID_1702746994" MODIFIED="1501829839362" TEXT=" // Apply direct lighting strategy">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="10"/>
</node>
<node CREATED="1501817707200" ID="ID_1642923554" MODIFIED="1501829839362" TEXT="switch(strategy)">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
<node CREATED="1501817714009" ID="ID_1290193181" MODIFIED="1501829839362" TEXT="case SAMPLE_ALL_UNIFORM: ">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
<node COLOR="#006699" CREATED="1501817767474" ID="ID_1930341964" MODIFIED="1501832709563" TEXT="L+=UniformSampleOneLight(scene,renderer,arena,p,n,wo,isect.rayEpsilon,ray.time,bsdf,sample,rng,lightNumOffset,lightSampleOffsets,bsdfSampleOffsets);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node COLOR="#006699" CREATED="1501819084334" ID="ID_1756847472" MODIFIED="1501832224001" TEXT="return (float)nLights * EstimateDirect(scene,renderer,arena,light,p,n,wo,rayEpsilon,time,bsdf,rng,lightSample,bsdfSample,BxDFType(BSDF_ALL &amp; ~BSDF_SPECULAR));">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
