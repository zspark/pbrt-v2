...
<node COLOR="#990000" CREATED="1501122632132" ID="ID_461266390" MODIFIED="1501234599558">
...
<node CREATED="1501125313702" ID="ID_267505771" MODIFIED="1501234599558" POSITION="right" TEXT="void SamplerRenderer::Render(const Scene *scene)">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node COLOR="#006699" CREATED="1501139553154" FOLDED="true" ID="ID_1162917260" MODIFIED="1501234627672">
<richcontent TYPE="NODE"><html>
  <head>
...
<node COLOR="#006699" CREATED="1501139612809" ID="ID_444853147" MODIFIED="1501234599542" TEXT="if(rayWeight&gt;0.f)Ls[i]=rayWeight * renderer-&gt;Li(scene,rays[i],&amp;samples[i],rng,arena,&amp;isects[i],&amp;Ts[i]);">
...
<node CREATED="1501158278298" FOLDED="true" ID="ID_1991648994" MODIFIED="1501234599480" POSITION="right" TEXT="Spectrum SamplerRenderer::Li(const Scene *scene,const RayDifferential &amp;ray,const Sample *sample,RNG &amp;rng,MemoryArena &amp;arena,Intersection *isect,Spectrum *T)">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
<node CREATED="1501154229887" ID="ID_770764746" MODIFIED="1501234461777" TEXT="Li=surfaceIntegrator-&gt;Li(scene,this,ray,*isect,sample,rng,arena);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node CREATED="1501210524825" FOLDED="true" ID="ID_1608468653" MODIFIED="1501234448899" TEXT="BSDF *bsdf = primitive-&gt;GetBSDF(dg, ObjectToWorld, arena);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node CREATED="1501210591761" ID="ID_744835466" MODIFIED="1501210593096" TEXT="return material-&gt;GetBSSRDF(dg, dgs, arena);">
...
<node CREATED="1501154592959" ID="ID_1031088743" MODIFIED="1501234461762" TEXT="if (ray.depth + 1 &lt; maxDepth)">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node CREATED="1501154733968" FOLDED="true" ID="ID_1641369673" MODIFIED="1501234461762" TEXT="L += SpecularReflect(ray, bsdf, rng, isect, renderer, scene, sample,arena);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node CREATED="1501154743279" FOLDED="true" ID="ID_206889962" MODIFIED="1501234461762" TEXT="L += SpecularTransmit(ray, bsdf, rng, isect, renderer, scene, sample,arena);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node CREATED="1501158421945" ID="ID_705614495" MODIFIED="1501234461762" TEXT="else">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
...
<node CREATED="1501158455234" ID="ID_5168828" MODIFIED="1501234461730" TEXT="Spectrum Lvi=volumeIntegrator-&gt;Li(scene,this,ray,sample,rng,T,arena);">
<font NAME="DejaVu Sans Mono for Powerline" SIZE="12"/>
</node>
